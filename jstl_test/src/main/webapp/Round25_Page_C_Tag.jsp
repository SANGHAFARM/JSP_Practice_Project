...
<body>
    ...
    <c:url value="http://localhost:8282/jstl_test/Round25_Page_ELView.jsp"/><br/>
    <c:url value="/Round25_Page_ELView.jsp" context="/jstl_test"/><br/>
    <c:url value="http://localhost:8282/jstl_test/Round25_Page_ELView.jsp" var="elurl" scope="request"/>
    <c:import url="${ requestScope.elurl }"/><br/><br/>
    <hr/>

    <c:import url="http://localhost:8282/jstl_test/Round25_Page_ELView.jsp"/>
    <c:import url="http://localhost:8282/jstl_test/Round25_Page_ELView.jsp" var="elview" scope="request"/>
    <c:import url="/Round25_Page_ELView.jsp" context="/jstl_test" varReader="in">
